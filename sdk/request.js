    ...
    ***************************************************************************** */
    ...
    class SessionRecorder {
                ...
                emit: (event, isCheckout) => {
                    if (isCheckout) {
                        ...
                        if (previousSessionRRWebEvents.length > 1) {
                            const timeElapsedInBucket = previousSessionRRWebEvents[previousSessionRRWebEvents.length - 1].timestamp -
        ...
        #interceptNetworkRequests(captureEventFn) {
            ...
            Network.intercept(/.*/, ({ method, url, requestData, responseJSON, responseURL, contentType, status, statusText, responseTime }) => {
